      ...
      <div class="content">
				<div class="rating-select" v-if="ratings.tab">
					...
					>
						...
						<img v-show="selectType == 0"  src="icon_sub_tab_dp_highlighted@2x.png" alt="">
				...
				<div class="labels-view">
					<span
						...
						:key="index"
						class="item"
						:class="{ 'highligh': item.label_star > 0}"
					>
						{{item.content}}{{item.label_content}}
					</span>
				</div>
						...
						>
								...
								<div class="comment-main">
									...
									<div class="star-wrapper">
										<Star :score="comment.order_comment_core"></Star>
									</div>
									<div class="content">
										{{comment.comment}}
									</div>
